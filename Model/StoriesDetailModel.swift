...
struct StoriesDetailModel : Codable {
let status : Bool?
let total : String?
let data : [Data]?
...
init(from decoder: Decoder) throws {
    ...
    struct Data : Codable, Hashable {
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case town = "town"
            case login_user_follow = "login_user_follow"
        }
        ...
        init(from decoder: Decoder) throws {
            ...
            login_user_follow = try values.decodeIfPresent(Int.self, forKey: .login_user_follow)
        }
