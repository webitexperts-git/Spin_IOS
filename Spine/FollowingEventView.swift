...
struct EventRow3: View {
    
    var event: FollowingEventModel.Data
    
    @State private var hasTitle = true
    
    @ObservedObject var followingEventViewModel = FollowingEventViewModel()
    var x = ""
    var body: some View {
...
struct FollowingEventView: View {
    ...
    var body: some View{
        VStack(alignment: .leading) {
            ...
            if($followingEventViewModel.woofUrl.wrappedValue != false){
            
                ForEach(followingEventViewModel.data, id: \.self){ data in
                   
                    EventRow3(event: data)
        ...
        .onAppear(perform: getFollowingEventData)
    ...
    func getFollowingEventData(){
        followingEventViewModel.getFollowingEventData()
